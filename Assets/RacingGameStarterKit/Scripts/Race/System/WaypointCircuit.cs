...
using UnityEditor;
    ...
    public class WaypointCircuit : MonoBehaviour
    {
        ...
        public float pathSmoothness = 100;
        ...
        private void DrawGizmos(bool selected)
        {
            ...
            if (Waypoints.Length > 1 && selected)
            {
                ...
                if(Waypoints[n].transform != this.transform)
                	Gizmos.DrawSphere (Waypoints[n].position, .75f);
                }
                    
                    for (float dist = 0; dist < Length; dist += Length/pathSmoothness)
                    {
...
[ExecuteInEditMode]
    ...
    public class WaypointListDrawer : PropertyDrawer
    {
        ...
        public void AddWaypoints(SerializedProperty property){
        var circuit = property.FindPropertyRelative("circuit").objectReferenceValue as WaypointCircuit;
        ...
        public class AssinWaypointsOnStart : MonoBehaviour{
